    ...
    for i in range(len(materials)):
        for j in range(len(tool_types)):
            ...
            if ttyp in other_tools:
                json_obj = {
                "parent": f"odyssey:item/weapon/bases/{ttyp}",
                "textures": {
                    "layer0": f"odyssey:item/weapon/{ttyp}_base_{mat}",
                    }
                }
            else:
                json_obj = {
                    "parent": f"odyssey:item/weapon/bases/{ttyp}",
                    "textures": {
                        "0": f"odyssey:item/weapon/{ttyp}_texture_{mat}",
                        "particle": f"odyssey:item/weapon/{ttyp}_texture_{mat}"
                    }
                }
